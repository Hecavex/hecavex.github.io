...
Atnaujinta 2026 m. rugpjūčio 14 d.
...
Kai pasirenkate kalbą arba vaizdo temą, šie pasirinkimai išsaugomi jūsų naršyklės vietinėje saugykloje (`localStorage`):

- `hecavex-language` įsimena, ar pasirinkote lietuvių, ar anglų kalbą.
- `theme` įsimena šviesios, tamsios arba sistemos temos pasirinkimą.
