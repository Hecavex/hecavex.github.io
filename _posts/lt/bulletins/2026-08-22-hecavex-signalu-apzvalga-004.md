...
description: "Aktyvi grėsmė viešiems PLC, devyni žinomi išnaudojami pažeidžiamumai, phishing per patikimas platformas, ransomware atkūrimo apgaulė ir Lietuvos pulsas. Laikotarpis: 2026 m. rugpjūčio 15–22 d."
...
high_count: 2
watch_count: 3
scope: "Gynėjams aktualūs pokyčiai, paskelbti arba į CISA KEV įtraukti 2026 m. rugpjūčio 15–22 d., ir dvi to paties laikotarpio Lietuvos policijos suvestinės apie sukčiavimą."
...
## Artimiausių 72 valandų darbai

1. **Rasti pasiekiamumą:** identifikuoti internetu pasiekiamus arba iš išorės pasiekiamu keliu turimus PLC, Zimbra, IKE, SharePoint, vCenter, TrueConf, Screen Sharing, Ray ir MLflow servisus. Kiekvienam paskirti savininką ir užfiksuoti versiją bei tinklo kelią.
2. **Taisyti pagal pasiekiamumą ir vaidmenį:** pirma pašalinti nereikalingą prieigą, tada diegti dabartines gamintojų pataisas. Ilgas CVE sąrašas neturi nustelbti vienos viešos sistemos, galinčios valdyti daugelį kitų.
3. **Žiūrėti atgal:** ieškoti neįprasto S7comm srauto per TCP/102, Snap7 ne engineering sistemose, įtartinų Zimbra child process, vCenter ar SharePoint administravimo pakeitimų ir netikėtų užklausų iš Ray ar MLflow hostų.
4. **Uždaryti žmogiškąją grandį:** įspėti apie dokumentus, prašančius vykdyti terminalo komandas, o incidentų komandoms nurodyti išsaugoti nekviestus ransomware atkūrimo pasiūlymus kaip įrodymus.
5. **Išsaugoti Lietuvos sukčiavimo įrodymus:** užfiksuoti visą pristatymo ir autorizavimo grandinę iki pasibaigiant nuorodų galiojimui, dingstant žinutėms ar iš naujo nustatant įrenginį.
