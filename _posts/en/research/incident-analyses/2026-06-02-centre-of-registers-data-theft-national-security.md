...
***The worst-case scenario is when someone quietly uses access for a long time, and the organization only finds out when the question is no longer "did it happen" but "how much did it go?"***
...
**For residents** that is, check information only in official sources, do not click on suspicious links (I remember the Citybee leak, when someone entered their data... well cmon), do not disclose login data by phone or e-mail. by mail, take your time with "very urgent" requests, use MFA and monitor bank accounts and potential new liabilities.

**For companies** it's a classic how to always prepare a little harder for more convincing social engineering attacks. Especially against accounting (MiTM), administration, managers, lawyers, RE, suppliers and customer service.

The authorities (I don't think it's necessary to explain here, but..) should look not only at one incident, but at the entire access chain.
