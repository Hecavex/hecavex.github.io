...
One of **possible scenarios** what I come up with looks like this (well, it's more classic here) that the employee receives **phishing** a letter (in the state legislatures, I wonder who conducts phishing training... or not, knowing about the Seimas, it's definitely not the case). The letter most likely looks like this:
...
What the system sees... it's "login successful", but it doesn't understand who logged in... whether it's Zose from finance or Sasha from Moscow.

Sometimes the worst attack looks like a normal employee, unless Zoe is a very exemplary employee and gets up at 3 am. at night to look at hundreds of thousands of register statements (because it's a lot of work), or Zose wants to become the MVP of the quarter.
...
To reiterate, Microsoft has publicly described that **Void Blizzard / Laundry Bear** actively used stolen logins from infostealer ecosystems and collected large volumes of emails. letters and files from organizations in Europe and North America.
