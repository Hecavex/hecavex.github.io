...
If the message comes from RT or Sputnik, most people understand, at least in theory, that skepticism should be turned on *(well, I clicked here with most people, but I hope it's true)*. If the same message comes from a "common man" in Facebook comments, a regional group or a newly appeared "independent" page, it seems more natural. This is where all beauty begins.. that dirty, cheap and efficient beauty of today.
...
And this is where AI has changed the economy *(no matter what you say, I hate AI, well, it's useful in certain places, but.. from a cyber security point of view..:) )*.
