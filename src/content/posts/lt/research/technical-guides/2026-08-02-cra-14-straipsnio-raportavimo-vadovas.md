...
seo_title: "CRA 14 straipsnis: 24 ir 72 valandų terminai"
seo_keywords:
...
<figure class="hx-evidence-figure">
  <img src="/assets/img/posts/2026-08-02-cra-article-14/cra-article-14-decision-tree-lt.svg" width="1200" height="1000" loading="lazy" alt="CRA 14 straipsnio techninių sprendimų medis nuo į taikymo sritį patenkančio signalo per pažeidžiamumo arba incidento įrodymų ribas iki 24 valandų perspėjimo ir vėlesnių ataskaitų">
  <figcaption>Statinis techninės sprendimų sekos vaizdas. Neigiamas arba neaiškus atsakymas grąžina bylą į dokumentuotą stebėjimą ir proporcingą įrodymų rinkimą.</figcaption>
</figure>
