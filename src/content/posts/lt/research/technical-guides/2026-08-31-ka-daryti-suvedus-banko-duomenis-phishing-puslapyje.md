...
![Pirmosios reagavimo valandos seka, skirta nuostoliui stabdyti, prieigai uždaryti ir įrodymams išsaugoti](/assets/img/posts/2026-08-31-post-phishing-banking-response/banking-first-hour-lt.svg)

*Schema: Pirmoji valanda yra veiksmų eilės modelis, o ne pažadas, kad pinigus visada dar galima susigrąžinti.*
...
![Po phishing atskleistų banko duomenų klasės, susiejančios kortelę, prisijungimo duomenis ir sesiją su skirtingais izoliavimo veiksmais](/assets/img/posts/2026-08-31-post-phishing-banking-response/banking-exposure-classes-lt.svg)

*Schema: Izoliavimo veiksmas priklauso nuo peržengusio saugumo ribą artefakto, o ne nuo bendros phishing etiketės.*

## Įrodymus išsaugokite pagal incidento izoliavimo seką

Įrodymų saugojimas nėra priežastis atidėti skambutį bankui. Teisinga seka išsaugo greitai kintančius faktus ir kartu uždaro užpuoliko prieigą:

1. **Sustabdykite naujus patvirtinimus.** Baikite skambutį ar pokalbį, atmeskite laukiančias užklausas ir nuotoliniu būdu valdytą įrenginį atjunkite nuo tinklų.
2. **Atidarykite nepriklausomą kanalą.** Iš žinomo švaraus įrenginio kreipkitės į banką per kortelėje nurodytą numerį, oficialią programėlę ar savarankiškai įvestą adresą.
3. **Užfiksuokite dabartinę finansinę būseną.** Užrašykite laukiančias ir atliktas operacijas, gavėjus, kortelės pridėjimą prie piniginių, kontaktų pakeitimus ir banko incidento numerį.
4. **Paprašykite banko izoliuoti jo valdomus artefaktus.** Tai gali būti kortelė, interneto banko prieiga, aktyvios sesijos, patikimi įrenginiai, laukiantys pavedimai ir nauji gavėjai.
5. **Apsaugokite susietas tapatybės paskyras.** Kai bankas apsaugo tiesioginį mokėjimo kelią, sutvarkykite el. pašto, mobiliojo ryšio ir kartoto slaptažodžio paskyras.
6. **Išsaugokite phishing įrodymus.** Eksportuokite ar nufotografuokite originalią žinutę, timestamp ir operacijos kontekstą neįkeldami URL iš naujo.
7. **Eskaluokite įrenginio įrodymus.** Jeigu įdiegta programa ar profilis, prieš reset ar valymą, kai praktiška, išsaugokite įrenginio būseną IT ar incidento tyrėjui.

Ši tvarka apsaugo nuo dviejų įprastų įrodymų klaidų. Pirmoji yra valandą analizuoti domeną, kol pavedimas palieka sąskaitą. Antroji yra per anksti išvalyti įrenginį ir panaikinti organizacijos incidento tyrėjui reikalingus persistence, nuotolinio valdymo ar credential theft požymius.

Veskite dvi laiko juostas. **Atakos laiko juostoje** fiksuokite žinutę, nuorodos atidarymą, duomenų suvedimą, patvirtinimus ir operacijas. **Reagavimo laiko juostoje** fiksuokite banko kontaktą, blokavimus, slaptažodžių pakeitimus, sesijų atšaukimą, pranešimus ir veiksmus su įrenginiu. Naudokite timestamp su laiko juosta. Netvirtinkite, kad po paspaudimo matoma operacija kilo iš puslapio, kol šio ryšio nepatvirtina bankas ar kiti įrodymai.
...
### Prieš skelbdami incidentą izoliuotu, nustatykite autentifikavimo artefaktą

Reagavimo metu verta atskirti bent penkias artefaktų klases:

| Artefaktas | Įprasta užpuoliko galimybė | Kokią kontrolę reikia patikrinti |
| --- | --- | --- |
| pakartotinai naudojamas slaptažodis ar statinis kliento identifikatorius | kartoti pirminio autentifikavimo bandymą | credential reset ir nepavykusių prisijungimų peržiūra |
| vienai operacijai susietas OTP, PIN ar patvirtinimas | užbaigti perduodamą operaciją, kol patvirtinimas galioja | banko operacijos peržiūra ir autentifikavimo teikėjo veiksmai |
| bearer sesijos slapukas ar access token | veikti kaip jau prisijungęs naudotojas iki galiojimo pabaigos ar atšaukimo | server-side sesijos ar token atšaukimas |
| patikimo įrenginio ar refresh token | gauti naujas sesijas nekartojant pirminio prisijungimo | įrenginio pasitikėjimo pašalinimas ir refresh grant atšaukimas |
| atkūrimo kodas, el. pašto ar mobiliojo ryšio atkūrimo prieiga | pakeisti credential ir iš naujo įsitvirtinti paskyroje | atkūrimo medžiagos atnaujinimas ir atkūrimo kanalų apsauga |

[NIST SP 800-63B sesijų rekomendacijos](https://pages.nist.gov/800-63-4/sp800-63b/session/) sesijos paslaptį laiko bearer credential ir reikalauja sesijos nutraukimo kontrolės. Dėl to slaptažodžio pakeitimas ir sesijos atšaukimas yra du atskirai tikrinami veiksmai. Sąsajos pranešimas "slaptažodis pakeistas" neįrodo, kad panaikintas kiekvienas aktyvus slapukas, mobilus token ar deleguotas grant.

Fiksuokite ne tik veiksmą, bet ir jo rezultatą. Užrašykite, kad bankas patvirtino interneto prieigos blokavimą, kad peržiūrėtas patikimų įrenginių sąrašas arba kad visos matomos sesijos pradėtos jau po izoliavimo. Jeigu paslauga nerodo atšaukimo vartotojui, banko ar teikėjo paklauskite, ką jis panaikino centralizuotai.

![Sesijos izoliavimo seka nuo kreipimosi į banką ir sesijų atšaukimo iki paskyros peržiūros bei stebėjimo](/assets/img/posts/2026-08-31-post-phishing-banking-response/banking-session-containment-lt.svg)

*Schema: Aktyvus pasitikėjimas atšaukiamas prieš atkuriant prisijungimo duomenis, nes pavogta sesija gali išlikti ilgiau už slaptažodį.*
...
Incidentą užbaikite pagal aiškius patikrinimus, ne pagal tylą:

- bankas patvirtino paveiktos kortelės ar interneto prieigos būseną
- neliko nepaaiškintos neautorizuotos laukiančios operacijos
- po izoliavimo peržiūrėtos visos sesijos ir patikimi įrenginiai
- el. pašto ir mobiliojo ryšio atkūrimo kanaluose nėra neautorizuotų pakeitimų
- nebeatsiranda neprašytų autentifikavimo užklausų
- galimai kompromituotas įrenginys ištirtas arba atkurtas pagal tinkamą planą
- policijos, NKSC, darbdavio ir banko registracijos numeriai susieti su ta pačia laiko juosta.

Stebėkite ir po to, kai gaunate naują kortelę ar slaptažodį. Vėliau pateiktas prekybininko mokėjimas, pakartotinai panaudoti asmens duomenys ar recovery fraud gali pasirodyti ne iš karto. Uždarytas phishing puslapis neuždaro paskyros incidento.
