...
for (const [path, expected] of [['en/tags', 105], ['lt/zymos', 100], ['en/categories', 12], ['lt/kategorijos', 12]]) {
...
if (htmlCount !== 317) failures.push(`legacy document surface changed: expected 317 HTML files, found ${htmlCount}`);

if (failures.length) {
  console.error(failures.join('\n'));
  process.exit(1);
}
console.log('Route parity passed: 128 indexed URLs, 317 HTML artifacts, all taxonomy routes, feeds, search, 404, redirects and security endpoints preserved.');
